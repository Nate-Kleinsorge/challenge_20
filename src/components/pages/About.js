...
export default function About() {
    return (
        <div className='text-center'>
            ...
            <p className="text-center" style={styles.content}>I am an aspiring web developer that is certified in web development through Michigan State University. I am looking to further my skills at an entry level job. I have learned much through the work in the intensive bootcamp from skills in the field to skills in everyday life. For example, I have learned a few database applications, including mySQL, mongoDB, and graphql. I have also learned React, express, and much more. My favorite part about being a web developer is the creative process and how it allows me to do things my way. I can create anything the only limit is my imagination and resources. I have worked hard to get this far, and I'm ready for the next step.</p>
        </div>
    );
}